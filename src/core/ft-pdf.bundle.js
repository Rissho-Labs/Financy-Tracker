...
`);
  ...
  // scripts/pdf-entry.mjs
  if (typeof window !== "undefined") {
    __webpack_exports__GlobalWorkerOptions.workerSrc = "/assets/pdf.worker.min.mjs";
  }
  ...
  async function loadPdf(dataUrl) {
    ...
    return __webpack_exports__getDocument({ data, useWorkerFetch: false, isEvalSupported: false }).promise;
  }
